...
class BalancePaymentDialog extends StatefulWidget {
  final Invoice invoice;
  final Function(PaymentMethod) onBalancePaid;

  const BalancePaymentDialog({
    super.key,
    required this.invoice,
    required this.onBalancePaid,
  });

  @override
  State<BalancePaymentDialog> createState() => _BalancePaymentDialogState();
}

class _BalancePaymentDialogState extends State<BalancePaymentDialog> {
        ...
        ElevatedButton.icon(
          onPressed: _isProcessing
              ...
              : () async {
                  ...
                  await widget.onBalancePaid(_selectedMethod);
                  if (mounted) {
          ...
          label: Text(_isProcessing ? 'Processing...' : 'Pay Balance'),
